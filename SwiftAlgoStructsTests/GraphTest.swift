...
class GraphTest: XCTestCase {
    ...
    func testDijkstraWithHeaps() {
        ...
        let shortestPath = testGraph.processDijkstraWithHeap(source: sourceVertex!, destination: destinationVertex!)
    ...
    func testDijkstra() {
        ...
        let shortestPath = testGraph.processDijkstra(source: sourceVertex!, destination: destinationVertex!)
        XCTAssertNotNil(shortestPath, "shortest path not found..")
